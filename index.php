...
<head>
    ...
    <title>Sycamore Auditing Firm</title>
...
<body>
    ...
    <div class=" overflow-x-hidden">
        <!-- navbar on lg -->
        <nav
            class="flex justify-between items-center py-6 px-4 lg:px-16 text-[#1a3066] font-medium bg-white fixed top-0 right-0 left-0 z-1000">
            <div>
                <a href="">
                    <img src="./assets/icons/logo-main-synamore.jpeg" alt="sceptre-logo" class="w-24 h-12">
                </a>
            </div>
            ...
            <div class="hidden lg:flex gap-7 scale-80">
                ...
                <a href="#philosophy" class="relative group">
                    <span>Philosophy</span>
                    <span
                        class="absolute bottom-0 left-0 w-0 h-0.5 bg-[#1a3066] group-hover:w-full transition-all duration-300 opacity-0 group-hover:opacity-100"></span>
                </a>
                <a href="#our-approach" class="relative group">
                ...
                <a href="#footer" class="relative group">
                    <span>Contact</span>
                    <span
                        class="absolute bottom-0 left-0 w-0 h-0.5 bg-[#1a3066] group-hover:w-full transition-all duration-300 opacity-0 group-hover:opacity-100"></span>
                </a>
            ...
            <div class="mobile-menu hidden lg:hidden absolute top-full left-0 right-0 bg-white shadow-lg py-4">
                <div class="flex flex-col space-y-4 px-4">
                    ...
                    <a href="#core-values" class="py-2 border-b border-gray-100">Core Values</a>
                    <a href="#services" class="py-2 border-b border-gray-100">Services</a>
                    <a href="#philosophy" class="py-2 border-b border-gray-100">Philosophy</a>
                    <a href="#our-approach" class="py-2 border-b border-gray-100">Our Approach</a>
                    <a href="#advisors" class="py-2 border-b border-gray-100">Board Members</a>
                    <a href="#footer" class="py-2 border-b border-gray-100">Contact Us</a>
                    <a href="" class="py-2 text-[#1a3066] font-semibold">Work With Us</a>
                </div>
            </div>
        </nav>

        <!-- hero section -->
        <div id="home" class="bg-[transparent] h-[600px] lg:h-screen">
            <div class="flex flex-col lg:flex-row relative h-[600px] lg:h-screen overflow-hidden">
                <!-- Slide 1: Sustainable Growth -->
                ...
                <div class="slide">
                    ...
                    <div>
                        <!-- <img src="./assets/images/single_man.png" alt=""
                            class="lg:h-screen h-[500px] top-30 lg:top-0 absolute right-0 w-[640px] lg:h-[1021px]"> -->
        ...
        <div id="sections-container" class="relative overflow-hidden h-[350px] lg:h-screen w-full scale-80">
            ...
            <section id="visionSection"
                ...
                <div class="absolute inset-y-0 right-0 flex items-center">
                    <button id="toMission" class="relative bg-[#1a3066] text-white font-bold flex flex-col items-center justify-center 
            h-full w-16 sm:w-20 md:w-24 transition-all">
                        <span class="rotate-180 text-xl [writing-mode:vertical-rl] tracking-wide">
                        </span>
                        <img src="./assets/images/vision.svg" alt="arrow"
                            class="absolute left-[-35px] sm:left-[-40px] top-1/4 -translate-y-1/2  md:w-30 lg:w-[79px]">
                    </button>
                </div>
            </section>
            ...
            <section id="missionSection"
                ...
                <div class="max-w-3xl mx-auto pl-12">
                    ...
                    <p class="text-lg sm:text-2xl lg:text-3xl">
                        Providing clients with top-notch and quality services backed by excellent expert knowledge
                        and innovation, from efficient, well-motivated, and professional teams.
                ...
                <div class="absolute inset-y-0 left-0 flex items-center bg-white scale-80">
                    <button id="toVision"
                        ...
                        <img src="./assets/images/mission.svg" alt="arrow"
                            class="absolute right-[-35px] sm:right-[-40px] top-1/4 -translate-y-1/2  lg:w-[79px]">
                    </button>
                </div>
            </section>
        </div>
        ...
        <div id="core-values" class="bg-gray-100 lg:px-15 lg:pb-15 lg:scale-80 my-0">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
                <div class=" bg-white text-black rounded-3xl py-6 px-8">
                    <div class="flex items-center gap-6 mb-5">
                        <img src="./assets/icons/0.png" alt="icon-0" class="w-[64px] h-[64px]">
                        <h4 class="font-bold text-[18px] lg:text-2xl">Stewardship</h4>
                    </div>
                    <p class="text-[18px]">We uphold a strong commitment to ethical and professional conduct in
                        everything we do.</p>
                </div>
                <div class=" bg-white text-black rounded-3xl py-6 px-8">
                    <div class="flex items-center gap-6 mb-5">
                        <img src="./assets/icons/1.png" alt="icon-0" class="w-[64px] h-[64px]">
                        <h4 class="font-bold text-[18px] lg:text-2xl">Excellence</h4>
                    </div>
                    <p class="text-[18px]">We have a passion to make a positive impact in the society. </p>
                </div>
                <div class=" bg-white text-black rounded-3xl py-6 px-8">
                    <div class="flex items-center gap-6 mb-5">
                        <img src="./assets/icons/2.png" alt="icon-0" class="w-[64px] h-[64px]">
                        <h4 class="font-bold text-2xl">Impact</h4>
                    </div>
                    <p class="text-[18px]">We are dedicated to conducting all of our dealings with openness and
                        fairness.</p>
                </div>
                <div class=" bg-white text-black rounded-3xl py-6 px-8">
                    <div class="flex items-center gap-6 mb-5">
                        <img src="./assets/icons/3.png" alt="icon-0" class="w-[64px] h-[64px]">
                        <h4 class="font-bold text-[18px] lg:text-2xl">Customer-driven</h4>
                    </div>
                    <p class="text-[18px]">We are dedicated to understanding and exceeding our clients’ expectations
                        through professionalism in every engagement.</p>
                </div>
                <div class=" bg-white text-black rounded-3xl py-6 px-8">
                    <div class="flex items-center gap-6 mb-5">
                        <img src="./assets/icons/4.png" alt="icon-0" class="w-[64px] h-[64px]">
                        <h4 class="font-bold text-[18px] lg:text-2xl">Innovation</h4>
                    </div>
                    <p class="text-[18px]">We continually seek creative and forward-thinking solutions to deliver
                        greater value.</p>
                </div>
                <div class=" bg-white text-black rounded-3xl py-6 px-8">
                    <div class="flex items-center gap-6 mb-5">
                        <img src="./assets/icons/5.png" alt="icon-0" class="w-[64px] h-[64px]">
                        <h4 class="font-bold text-[18px] lg:text-2xl">Commitment</h4>
                    </div>
                    <p class="text-[18px]">We work alongside our clients to achieve their growth and transformation
                        objectives.</p>
                </div>
            </div>
        </div>
        ...
        <div id="services"
            ...
            <div>
                ...
                <div class="flex flex-col items-start gap-4 mb-8">
                    <div class=" rounded">
                        <img src="./assets/icons/weight.svg" alt="icon" class="w-[40px] h-[40px]">
                    </div>
                    <div>
                ...
                <div class="flex flex-col items-start gap-4">
                    <div class=" rounded">
                        <img src="./assets/icons/people.svg" alt="icon" class="w-[40px] h-[40px]">
                    </div>
                    <div>
            ...
            <div>
                ...
                <div class="flex flex-col items-start gap-4 mb-8">
                    <div class=" rounded">
                        <img src="./assets/icons/wallet.svg" alt="icon" class="w-[40px] h-[40px]">
                    </div>
                    <div>
                ...
                <div class="flex flex-col items-start gap-4">
                    <div class=" rounded">
                        <img src="./assets/icons/coins.svg" alt="icon" class="w-[40px] h-[40px]">
                    </div>
                    <div>
        ...
        <div id="philosophy" class="py-[100px]  bg-gray-100 lg:scale-80">
            ...
            <button
                class="group relative overflow-hidden border border-2 border-black mb-10 w-[200px] h-[70px] rounded-full mx-auto flex items-center justify-center gap-4 text-black transition-all duration-500">

                <!-- Sliding black overlay -->
                <span
                    class="absolute inset-0 bg-black -translate-x-full group-hover:translate-x-0 transition-transform duration-500 ease-out"></span>

                <!-- Button content -->
                <div
                    class="relative flex items-center gap-3 transition-transform duration-500 ease-out group-hover:translate-x-2">
                    <a href="#footer-form"
                        class="text-lg font-medium group-hover:text-white transition-colors duration-300">
                        Get in touch
                    </a>
                    <img src="./assets/icons/arrow-right.svg" alt="arrow-right"
                        class="w-5 h-5 transition-all duration-300 group-hover:brightness-0 group-hover:invert">
                </div>
            </button>

            <img src="./assets/images/sycamore-board.png" alt="random-2" class="lg:w-[70%] lg:h-[40em] mx-auto">
        </div>
        ...
        <div id="our-approach" class="pt-[100px] lg:bg-gray-200 lg:scale-80">
            <h3 class="lg:text-3xl text-2xl font-bold w-[95%] lg:w-[70%] mx-auto mb-10">
                ...
                businesses.
                Our role is to connect entrepreneurs and high-potential enterprises with the capital
                providers that can drive their growth.
            </h3>
            <p class="text-2xl w-[95%] lg:w-[70%] mx-auto"></p>
            <div class="relative py-[100px]">
                <!-- Continuous Scrolling Container -->
                <!-- <div class="flex items-center gap-16 animate-scroll-loop hover:[animation-play-state:paused]"> -->

                <!--I Duplicated section twice for infinite looping -->
                <template id="scroll-items">
                    <!-- ITEM 1 -->
                    <div class="relative group flex flex-col items-center cursor-pointer shrink-0 tooltip-item">
                        <div
                            class="bg-teal-600 text-white w-10 h-10 flex items-center justify-center rounded-full font-bold">
                            1</div>
                        <p class="mt-2 font-semibold text-gray-800 whitespace-nowrap">Deal Sourcing</p>
                        <!-- Tooltip -->
                        <div
                            class="tooltip-content absolute mt-3 group-hover:opacity-100 opacity-0 transition-all duration-300 w-72 bg-white rounded-2xl shadow-xl p-4 text-sm text-gray-600 z-50 pointer-events-none">
                            <h4 class="font-semibold text-gray-900 mb-2">Deal Sourcing</h4>
                            <p>Sceptre identifies and researches businesses in need of growth and expansion capital.
                                We ensure rigorous due diligence.</p>
                    ...
                    <div class="relative group flex flex-col items-center cursor-pointer shrink-0 tooltip-item">
                        <div
                            class="bg-teal-600 text-white w-10 h-10 flex items-center justify-center rounded-full font-bold">
                            2</div>
                        <p class="mt-2 font-semibold text-gray-800 whitespace-nowrap">Investor Analysis</p>
                        <div
                            class="tooltip-content absolute mt-3 group-hover:opacity-100 opacity-0 transition-all duration-300 w-72 bg-white rounded-2xl shadow-xl p-4 text-sm text-gray-600 z-50 pointer-events-none">
                            <h4 class="font-semibold text-gray-900 mb-2">Investor Analysis</h4>
                            <p>We analyze potential investors to align their goals with scalable opportunities and
                                ensure strong portfolio matches.</p>
                            <span class="tooltip-arrow"></span>
                        </div>
                    </div>
                    ...
                    <div class="relative group flex flex-col items-center cursor-pointer shrink-0 tooltip-item">
                        <div
                            class="bg-teal-600 text-white w-10 h-10 flex items-center justify-center rounded-full font-bold">
                            3</div>
                        <p class="mt-2 font-semibold text-gray-800 whitespace-nowrap">Execution</p>
                        <div
                            class="tooltip-content absolute mt-3 group-hover:opacity-100 opacity-0 transition-all duration-300 w-72 bg-white rounded-2xl shadow-xl p-4 text-sm text-gray-600 z-50 pointer-events-none">
                            <h4 class="font-semibold text-gray-900 mb-2">Execution</h4>
                            <p>Our team ensures seamless execution of investment plans with transparency and
                                accountability.</p>
                            <span class="tooltip-arrow"></span>
                        </div>
                    </div>
                    ...
                    <div class="relative group flex flex-col items-center cursor-pointer shrink-0 tooltip-item">
                        <div
                            class="bg-teal-600 text-white w-10 h-10 flex items-center justify-center rounded-full font-bold">
                            4</div>
                        <p class="mt-2 font-semibold text-gray-800 whitespace-nowrap">Performance Evaluation</p>
                        <div
                            class="tooltip-content absolute mt-3 group-hover:opacity-100 opacity-0 transition-all duration-300 w-72 bg-white rounded-2xl shadow-xl p-4 text-sm text-gray-600 z-50 pointer-events-none">
                            <h4 class="font-semibold text-gray-900 mb-2">Performance Evaluation</h4>
                            <p>We measure business performance post-investment to track growth and ensure
                    ...
                    <div class="relative group flex flex-col items-center cursor-pointer shrink-0 tooltip-item">
                        <div
                            class="bg-teal-600 text-white w-10 h-10 flex items-center justify-center rounded-full font-bold">
                            5</div>
                        <p class="mt-2 font-semibold text-gray-800 whitespace-nowrap">Investment Exit</p>
                        <div
                            class="tooltip-content absolute mt-3 group-hover:opacity-100 opacity-0 transition-all duration-300 w-72 bg-white rounded-2xl shadow-xl p-4 text-sm text-gray-600 z-50 pointer-events-none">
                            <h4 class="font-semibold text-gray-900 mb-2">Investment Exit</h4>
                            <p>We identify the right time and strategy to exit investments with optimal returns for
                                all stakeholders.</p>
                            <span class="tooltip-arrow"></span>
                        </div>
                    </div>
                    ...
                    <div class="relative group flex flex-col items-center cursor-pointer shrink-0 tooltip-item">
                        <div
                            class="bg-teal-600 text-white w-10 h-10 flex items-center justify-center rounded-full font-bold">
                            6</div>
                        <p class="mt-2 font-semibold text-gray-800 whitespace-nowrap">Risk Management</p>
                        <div
                            class="tooltip-content absolute mt-3 group-hover:opacity-100 opacity-0 transition-all duration-300 w-72 bg-white rounded-2xl shadow-xl p-4 text-sm text-gray-600 z-50 pointer-events-none">
                            <h4 class="font-semibold text-gray-900 mb-2">Risk Management</h4>
                            <p>We assess and mitigate financial and operational risks to protect investments and
                                ensure long-term stability.</p>
                            <span class="tooltip-arrow"></span>
                        </div>
                    </div>
                    ...
                    <div class="relative group flex flex-col items-center cursor-pointer shrink-0 tooltip-item">
                        <div
                            class="bg-teal-600 text-white w-10 h-10 flex items-center justify-center rounded-full font-bold">
                            7</div>
                        <p class="mt-2 font-semibold text-gray-800 whitespace-nowrap">Advisory Services</p>
                        <div
                            class="tooltip-content absolute mt-3 group-hover:opacity-100 opacity-0 transition-all duration-300 w-72 bg-white rounded-2xl shadow-xl p-4 text-sm text-gray-600 z-50 pointer-events-none">
                            <h4 class="font-semibold text-gray-900 mb-2">Advisory Services</h4>
                            <p>Providing expert guidance on mergers, acquisitions, and strategic partnerships for
                    ...
                    <div class="relative group flex flex-col items-center cursor-pointer shrink-0 tooltip-item">
                        <div
                            class="bg-teal-600 text-white w-10 h-10 flex items-center justify-center rounded-full font-bold">
                            8</div>
                        <p class="mt-2 font-semibold text-gray-800 whitespace-nowrap">Capital Raising</p>
                        <div
                            class="tooltip-content absolute mt-3 group-hover:opacity-100 opacity-0 transition-all duration-300 w-72 bg-white rounded-2xl shadow-xl p-4 text-sm text-gray-600 z-50 pointer-events-none">
                            <h4 class="font-semibold text-gray-900 mb-2">Capital Raising</h4>
                            <p>Helping businesses secure funding through equity, debt, or alternative financing
                                options tailored to their needs.</p>
                            <span class="tooltip-arrow"></span>
                        </div>
                    </div>
                    ...
                    <div class="relative group flex flex-col items-center cursor-pointer shrink-0 tooltip-item">
                        <div
                            class="bg-teal-600 text-white w-10 h-10 flex items-center justify-center rounded-full font-bold">
                            9</div>
                        <p class="mt-2 font-semibold text-gray-800 whitespace-nowrap">Market Research</p>
                        <div
                            class="tooltip-content absolute mt-3 group-hover:opacity-100 opacity-0 transition-all duration-300 w-72 bg-white rounded-2xl shadow-xl p-4 text-sm text-gray-600 z-50 pointer-events-none">
                            <h4 class="font-semibold text-gray-900 mb-2">Market Research</h4>
                            <p>Conducting in-depth market analysis to identify trends, opportunities, and
                    ...
                    <div class="relative group flex flex-col items-center cursor-pointer shrink-0 tooltip-item">
                        <div
                            class="bg-teal-600 text-white w-10 h-10 flex items-center justify-center rounded-full font-bold">
                            10</div>
                        <p class="mt-2 font-semibold text-gray-800 whitespace-nowrap">Compliance & Reporting</p>
                        <div
                            class="tooltip-content absolute mt-3 group-hover:opacity-100 opacity-0 transition-all duration-300 w-72 bg-white rounded-2xl shadow-xl p-4 text-sm text-gray-600 z-50 pointer-events-none">
                            <h4 class="font-semibold text-gray-900 mb-2">Compliance & Reporting</h4>
                            <p>Ensuring regulatory compliance and transparent reporting for all investment
                                activities and stakeholders.</p>
                            <span class="tooltip-arrow"></span>
                        </div>
                    </div>
                </template>
